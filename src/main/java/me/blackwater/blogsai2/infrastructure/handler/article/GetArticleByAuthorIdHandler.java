...
@Handler(handlerType = HandlerType.GET,name = "article by authorId",transactional = true)
@RequiredArgsConstructor
public class GetArticleByAuthorIdHandler implements GetHandler<List<Article>, Long> {
    private final ArticleRepository articleRepository;

    @Override
    public List<Article> execute(Long authorId) {
        final List<Article> articles = articleRepository.findByAuthorId(authorId);
