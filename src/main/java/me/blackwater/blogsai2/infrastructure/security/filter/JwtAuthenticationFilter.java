package me.blackwater.blogsai2.infrastructure.security.filter;
...
import me.blackwater.blogsai2.domain.exception.JwtTokenExpiredException;
            ...
            if (authenticationHeader.startsWith("Bearer ")) {
                try {
                    ...
                    if(jwt.getExpiresAt() != null && jwt.getExpiresAt().isBefore(now())){
                        handleJwtException(response, new JwtTokenExpiredException("Token has expired"));
                        return;
                    }
